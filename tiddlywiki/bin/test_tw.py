...
Run tests with:
    python3 test_tw.py                    # Run all tests (includes filter tests)
...
This test suite includes both TiddlyWiki file operation tests and filter tests
(imported from test_tw_filter.py). This is the single entrypoint for all tests.
...
from test_tw_filter import (
    TestMathOperators,
    TestStringOperators,
    TestStringManipulationOperators,
    TestListOperators
)
